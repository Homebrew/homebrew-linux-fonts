class FontCommitMono < Formula
  ...
  def install
    (share/"fonts").install Dir.glob("./**/CommitMono-400-Italic.otf")[0]
    (share/"fonts").install Dir.glob("./**/CommitMono-400-Regular.otf")[0]
    (share/"fonts").install Dir.glob("./**/CommitMono-700-Italic.otf")[0]
    (share/"fonts").install Dir.glob("./**/CommitMono-700-Regular.otf")[0]
  end
