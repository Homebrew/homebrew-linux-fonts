class FontBlexMonoNerdFont < Formula
  ...
  desc "BlexMono Nerd Font families (IBM Plex Mono)"
  desc "Developer targeted fonts with a high number of glyphs"
  homepage "https://github.com/ryanoasis/nerd-fonts"
  def install
    (share/"fonts").install "BlexMonoExtLtNerdFont-Italic.ttf"
    (share/"fonts").install "BlexMonoExtLtNerdFont-Regular.ttf"
    (share/"fonts").install "BlexMonoExtLtNerdFontMono-Italic.ttf"
    (share/"fonts").install "BlexMonoExtLtNerdFontMono-Regular.ttf"
    (share/"fonts").install "BlexMonoExtLtNerdFontPropo-Italic.ttf"
    (share/"fonts").install "BlexMonoExtLtNerdFontPropo-Regular.ttf"
    (share/"fonts").install "BlexMonoMedmNerdFont-Italic.ttf"
    (share/"fonts").install "BlexMonoMedmNerdFont-Regular.ttf"
    (share/"fonts").install "BlexMonoMedmNerdFontMono-Italic.ttf"
    (share/"fonts").install "BlexMonoMedmNerdFontMono-Regular.ttf"
    (share/"fonts").install "BlexMonoMedmNerdFontPropo-Italic.ttf"
    (share/"fonts").install "BlexMonoMedmNerdFontPropo-Regular.ttf"
    ...
    (share/"fonts").install "BlexMonoSmBldNerdFont-Italic.ttf"
    (share/"fonts").install "BlexMonoSmBldNerdFont-Regular.ttf"
    (share/"fonts").install "BlexMonoSmBldNerdFontMono-Italic.ttf"
    (share/"fonts").install "BlexMonoSmBldNerdFontMono-Regular.ttf"
    (share/"fonts").install "BlexMonoSmBldNerdFontPropo-Italic.ttf"
    (share/"fonts").install "BlexMonoSmBldNerdFontPropo-Regular.ttf"
    (share/"fonts").install "BlexMonoTextNerdFont-Italic.ttf"
    (share/"fonts").install "BlexMonoTextNerdFont-Regular.ttf"
    (share/"fonts").install "BlexMonoTextNerdFontMono-Italic.ttf"
    (share/"fonts").install "BlexMonoTextNerdFontMono-Regular.ttf"
    (share/"fonts").install "BlexMonoTextNerdFontPropo-Italic.ttf"
    (share/"fonts").install "BlexMonoTextNerdFontPropo-Regular.ttf"
  end
  test do
  end
end
