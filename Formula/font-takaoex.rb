class FontTakaoex < Formula
  ...
  def install
    (share/"fonts").install Dir.glob(""ofl/tajawal/" + TakaoExFonts_#{version}/**/TakaoExGothic.ttf")[0]
    (share/"fonts").install Dir.glob(""ofl/tajawal/" + TakaoExFonts_#{version}/**/TakaoExMincho.ttf")[0]
  end
