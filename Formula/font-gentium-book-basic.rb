class FontGentiumBookBasic < Formula
  ...
  def install
    (share/"fonts").install Dir.glob("./**/GenBkBasB.ttf")[0]
    (share/"fonts").install Dir.glob("./**/GenBkBasBI.ttf")[0]
    (share/"fonts").install Dir.glob("./**/GenBkBasI.ttf")[0]
    (share/"fonts").install Dir.glob("./**/GenBkBasR.ttf")[0]
  end
