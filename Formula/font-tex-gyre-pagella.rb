class FontTexGyrePagella < Formula
  ...
  def install
    (share/"fonts").install Dir.glob("./**/texgyrepagella-bold.otf")[0]
    (share/"fonts").install Dir.glob("./**/texgyrepagella-bolditalic.otf")[0]
    (share/"fonts").install Dir.glob("./**/texgyrepagella-italic.otf")[0]
    (share/"fonts").install Dir.glob("./**/texgyrepagella-regular.otf")[0]
  end
