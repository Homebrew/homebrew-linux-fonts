class FontGentiumBasic < Formula
  ...
  def install
    (share/"fonts").install Dir.glob("./**/GenBasB.ttf")[0]
    (share/"fonts").install Dir.glob("./**/GenBasBI.ttf")[0]
    (share/"fonts").install Dir.glob("./**/GenBasI.ttf")[0]
    (share/"fonts").install Dir.glob("./**/GenBasR.ttf")[0]
  end
