class FontAtkinsonHyperlegible < Formula
  ...
  def install
    (share/"fonts").install Dir.glob("./**/Print Fonts/Atkinson-Hyperlegible-Bold-102.otf")[0]
    (share/"fonts").install Dir.glob("./**/Print Fonts/Atkinson-Hyperlegible-BoldItalic-102.otf")[0]
    (share/"fonts").install Dir.glob("./**/Print Fonts/Atkinson-Hyperlegible-Italic-102.otf")[0]
    (share/"fonts").install Dir.glob("./**/Print Fonts/Atkinson-Hyperlegible-Regular-102.otf")[0]
  end
