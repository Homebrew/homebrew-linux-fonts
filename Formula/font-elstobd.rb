class FontElstobd < Formula
  ...
  def install
    (share/"fonts").install Dir.glob(""ofl/elsie/" + Elstob_font/variable/**/Elstob-Italic.ttf")[0]
    (share/"fonts").install Dir.glob(""ofl/elsie/" + Elstob_font/variable/**/Elstob.ttf")[0]
  end
