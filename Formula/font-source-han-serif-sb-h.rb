class FontSourceHanSerifSbH < Formula
  ...
  def install
    (share/"fonts").install "../SourceHanSerifOTC_SB-HSourceHanSerif-SemiBold.ttc"
    (share/"fonts").install "../SourceHanSerifOTC_SB-HSourceHanSerif-Bold.ttc"
    (share/"fonts").install "../SourceHanSerifOTC_SB-HSourceHanSerif-Heavy.ttc"
  end
  def creavat; <<~EOS
